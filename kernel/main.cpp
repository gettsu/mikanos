...
void TaskB(uint64_t task_id, int64_t data) {
  ...
  while (true) {
    ...
    FillRectangle(*task_b_window->InnerWriter(), {20, 4}, {8 * 10, 16}, {0x50, 0x49, 0x46});
    WriteString(*task_b_window->InnerWriter(), {20, 4}, str, {255, 255, 255});
...
extern "C" void KernelMainNewStack(
  ...
  while (true) {
    ...
    FillRectangle(*main_window->InnerWriter(), {20, 4}, {8 * 10, 16}, {0x50, 0x49, 0x46});
    WriteString(*main_window->InnerWriter(), {20, 4}, str, {255, 255, 255});
